...
\noindent\begin{table}[H]
            ...
            \end{tabular}\\
            \caption{FR4.10 - Planning markeren als voorstel}
            \label{tab:FR4.10 - Planning markeren als voorstel}
        \end{table}
...
\noindent\begin{table}[H]
            ...
            \end{tabular}\\
            \caption{FR4.11 - Vakken verwijderen van lesprogramma}
            \label{tab:FR4.11 - Vakken verwijderen van lesprogramma}
        \end{table}    
