...
\begin{thebibliography}{99}
	...
	\bibitem{Disqus} \emph{Disqus.} \url{http://disqus.com}
	
	\bibitem{SilverStripe} \emph{SilverStripe.} \url{http://www.silverstripe.org}
	
	\bibitem{BootStrapJS} \emph{BootStrap JS.} \url{http://getbootstrap.com}
	
	\bibitem{BootStrapCalender} \emph{BootStrap Calender} \url{http://bootstrap-calendar.azurewebsites.net}
	
	\bibitem{SourceTree} \emph{SourceTree.} \url{http://www.sourcetreeapp.com}
	
	\bibitem{GitHubWindows} \emph{GitHub Windows} \url{http://windows.github.com}
	
	\bibitem{GitHubMac} \emph{GitHub Mac} \url{http://mac.github.com}
