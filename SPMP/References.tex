...
\begin{thebibliography}{99}
    ...
    \bibitem{JensNicolay} \emph{Jens Nicolay.} \href{mailto:jnicolay@vub.ac.be}{jnicolay@vub.ac.be}
    
    \bibitem{RagnhildVanDerStraeten} \emph{Ragnhild Van Der Straeten.} \href{mailto:rvdstrae@vub.ac.be}{rvdstrae@vub.ac.be}
    
    \bibitem{DirkVanDeun} \emph{Dirk van Deun.} \href{mailto:dirk@dinf.vub.ac.be}{dirk@dinf.vub.ac.be}
